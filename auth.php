        ...
        <div class="auth-card">
          ...
          <form action="login.php" method="POST" novalidate>
            ...
            <div class="form-group">
              <input type="text" name="email" placeholder="Email address" required autocomplete="email">
              <div class="pw-wrap">
        ...
        <div class="auth-card">
          ...
          <form action="register.php" method="POST" novalidate>
            ...
            <div class="form-group">
              ...
              <input type="text" name="email" placeholder="Email address" required autocomplete="email" value="<?= htmlspecialchars($old['email'] ?? '') ?>">
  ...
  <script>
    ...
    document.querySelectorAll('.auth-panel form').forEach(function(form) {
      form.addEventListener('keydown', function(e) {
        ...
        var fields = Array.from(form.querySelectorAll('input, select')).filter(function(el) {
          return !el.closest('[type=hidden]') && el.type !== 'hidden';
        });
